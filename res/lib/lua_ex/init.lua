...
function class(classname, ...)
    ...
    for _, super in ipairs(supers) do
        ...
        assert(superType == "nil" or superType == "table" or superType == "function", string.format(
            "class() - create class \"%s\" with invalid super class type \"%s\"", classname, superType))
        ...
        elseif superType == "table" then
            if super[".isclass"] then
                ...
                assert(cls.__create == nil, string.format(
                    "class() - create class \"%s\" with more than one creating function or native class", classname));
...
import("lib.lua_ex.string_ex")
import("lib.lua_ex.table_ex")
import("lib.lua_ex.io_ex")
import("lib.lua_ex.math_ex")
import("lib.lua_ex.g_ex")
