...
namespace sol_ImGui
{
    ...
    inline std::tuple<sol::as_table_t<std::vector<float>>, bool> DragFloat2(const std::string &label, const sol::table &v)
    {
        ...
        auto float2 = std::vector<float>{value[0], value[1]};
        //sol::as_table_t float2 = sol::as_table();
    ...
    inline std::tuple<sol::as_table_t<std::vector<float>>, bool> DragFloat3(const std::string &label, const sol::table &v)
    {
        ...
        auto float3 = std::vector<float>{value[0], value[1], value[2]};
    ...
    inline std::tuple<sol::as_table_t<std::vector<float>>, bool> DragFloat4(const std::string &label, const sol::table &v)
    {
        ...
        auto float4 = std::vector<float>{value[0], value[1], value[2], value[3]};
    ...
    inline std::tuple<sol::as_table_t<std::vector<int>>, bool> DragInt2(const std::string &label, const sol::table &v)
    {
        ...
        auto int2 = std::vector<int>{value[0], value[1]};
    ...
    inline std::tuple<sol::as_table_t<std::vector<int>>, bool> DragInt3(const std::string &label, const sol::table &v)
    {
        ...
        auto int3 = std::vector<int>{value[0], value[1], value[2]};
    ...
    inline std::tuple<sol::as_table_t<std::vector<int>>, bool> DragInt4(const std::string &label, const sol::table &v)
    {
        ...
        auto int4 = std::vector<int>{value[0], value[1], value[2], value[3]};
    ...
    inline std::tuple<sol::as_table_t<std::vector<float>>, bool> SliderFloat3(const std::string &label, const sol::table &v, float v_min, float v_max)
    {
        ...
        auto float3 = std::vector<float>{value[0], value[1], value[3]};
    ...
    {
        bool selected = ImGui::InputTextMultiline(label.c_str(), &text[0], buf_size, {sizeX, sizeY}, static_cast<ImGuiInputTextFlags>(flags));
        return std::make_tuple(text, selected);
    }
    ...
    {
        bool selected = ImGui::InputTextWithHint(label.c_str(), hint.c_str(), &text[0], buf_size, static_cast<ImGuiInputTextFlags>(flags));
        return std::make_tuple(text, selected);
    }
    ...
    {
        bool selected = ImGui::InputFloat(label.c_str(), &v, step, step_fast, format.c_str(), static_cast<ImGuiInputTextFlags>(flags));
        return std::make_tuple(v, selected);
    }
    ...
    inline std::tuple<sol::as_table_t<std::vector<float>>, bool> ColorEdit3(const std::string &label, const sol::table &col)
    {
        ...
        auto rgb = std::vector<float>{color[0], color[1], color[2]};
    ...
    inline std::tuple<sol::as_table_t<std::vector<float>>, bool> ColorEdit4(const std::string &label, const sol::table &col)
    {
        ...
        auto rgba = std::vector<float>{color[0], color[1], color[2], color[3]};
    ...
    //{ /* TODO: SetNextWindowClass(...) ==> UNSUPPORTED */
    //}
    ...
    inline void InitEnums(sol::table& ns)
    {
#pragma region Window Flags
        ns.create_named("ImGuiWindowFlags",
...
#pragma region Focused Flags
        ns.create_named("ImGuiFocusedFlags",
...
#pragma region Hovered Flags
        ns.create_named("ImGuiHoveredFlags",
...
#pragma region Combo Flags
        ns.create_named("ImGuiComboFlags",
...
#pragma region InputText Flags
        ns.create_named("ImGuiInputTextFlags",
...
#pragma region ColorEdit Flags
        ns.create_named("ImGuiColorEditFlags",
...
#pragma region TreeNode Flags
        ns.create_named("ImGuiTreeNodeFlags",
...
#pragma region Selectable Flags
        ns.create_named("ImGuiSelectableFlags",
...
#pragma region Popup Flags
        //ns.create_named("ImGuiPopupFlags",
...
#pragma region TabBar Flags
        ns.create_named("ImGuiTabBarFlags",
...
#pragma region TabItem Flags
        //ns.create_named("ImGuiTabItemFlags",
...
#pragma region DockNode Flags
        //ns.create_named("ImGuiDockNodeFlags",
...
#pragma region MouseButton
        ns.create_named("ImGuiMouseButton",
...
#pragma region MouseCursor
        ns.create_named("ImGuiMouseCursor",
