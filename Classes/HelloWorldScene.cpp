...
void HelloWorld::createSpineTest()
{
    ...
    _atlas = spAtlas_createFromFile("res/spine/spineboy.atlas", 0);
    ...
    _skeletonData = spSkeletonJson_readSkeletonDataFile(json, "res/spine/spineboy-ess.json");
